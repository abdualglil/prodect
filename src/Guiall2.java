...
public class Guiall2 extends javax.swing.JFrame {// الواجهه الرئيسه 2
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Guiall2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
