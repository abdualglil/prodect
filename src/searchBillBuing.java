...
public class searchBillBuing extends javax.swing.JFrame { // واجهه البحث عن فاتوره شراء
    private java.util.Date det=new Date();
    private SimpleDateFormat sf=new SimpleDateFormat("yyyy/MM/dd");
    private int a;
    BillsBuing billsBuing=new BillsBuing();


    public searchBillBuing() {
        initComponents();
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(datenow, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(datenow, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(4, 4, 4)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void searshActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        name_bill.setText(billsBuing.Searchname(a).get(0)+"");
        sum.setText(billsBuing.Searchname(a).get(1)+"");
        deatold.setText(billsBuing.Searchname(a).get(2)+"");
        Table.setModel(billsBuing.model(a));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchBillBuing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchBillBuing().setVisible(true);
            }
        });
    }
